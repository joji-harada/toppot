...
#EDIT THE FOLLOWING:
$toAddress = "georgealbertallison@gmail.com";  //place your/your client's email address here
$toName = "George Allison"; //place your client's name here
...
if ($response != null && $response->success)
    ...
    <div class="contact-feedback">
        ...
        <p>We'll respond via email within 48 hours, if your requested information.</p>
    </div>    
    <!-- END HTML FEEDBACK -->        
    <?php
